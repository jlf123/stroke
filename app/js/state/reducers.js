...
const replaceDocument = (value, actions) => setTimeout(() => actions.replaceDocument(value))
...
const reducersByActionType = {
    ...
    [ActionType.FETCH_USER_NOTES_REQUEST_SUCCEEDED]: (state, { payload: { notes } }) => ({
        ...state,
        notes: notes,
        isFetchingUserNotes: false,
        errorFetchingNotes: null
    }),
    [ActionType.FETCH_USER_NOTES_REQUEST_FAILED]: (state, { payload: { error } }) => ({
        ...state,
        isFetchingUserNotes: false,
        errorFetchingNotes: error
    }),
    [ActionType.QUEUE_USER_NOTES_UPDATE]: (state, { payload: { key, value, title } }) => {
    ...
    [ActionType.CREATE_NEW_USER_NOTE]: (state, { payload: { value, title} }) => {
    ...
    [ActionType.ADD_EDITOR_ACTIONS_STROKE]: (state, { payload: { actions }}) => {
    ...
    [ActionType.TRASH_USER_NOTE_REQUESTED]: (state, { payload: { key, title }}) => ({
        ...state,
        isDeletingNote: true,
        pendingNoteDeletion: {
            key,
