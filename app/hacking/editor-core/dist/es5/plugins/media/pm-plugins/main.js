...
var MediaPluginState = /** @class */ (function () {
    function MediaPluginState(state, options, reactContext, editorAppearance) {
            ...
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, picker_facade_loader_1.default()];
                    case 3:
                        Picker = _d.sent();
        ...
        this.insertFiles = function (mediaStates) {
            ...
            var nonImageAttachments = mediaStates.filter(function (media) { return !utils_1.isImage(media.fileMimeType); });
            ...
            if (_this.editorAppearance !== 'message' && mediaSingle) {
                media_files_1.insertMediaGroupNode(_this.view, nonImageAttachments, collection);
        ...
        this.handleMediaNodeRemoval = function (node, getPos) {
            ...
            media_common_1.removeMediaNode(_this.view, getNode, getPos);
        };
        /**
        ...
        this.handleMediaState = function (state) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                isMediaSingle = utils_1.isImage(state.fileMimeType) && !!this.view.state.schema.nodes.mediaSingle;
                switch (state.status) {
                    case 'error':
        ...
        this.removeNodeById = function (state) {
            var id = state.id;
            var mediaNodeWithPos = utils_1.isImage(state.fileMimeType)
                ? _this.findMediaNode(id)
                : _this.mediaGroupNodes[id];
            if (mediaNodeWithPos) {
        ...
        this.errorReporter = options.errorReporter || new editor_common_1.ErrorReporter();
    }
...
exports.createPlugin = function (schema, options, reactContext, dispatch, editorAppearance) {
            ...
            decorations: function (state) {
                ...
                if (state.selection instanceof prosemirror_state_1.NodeSelection) {
                    ...
                    if (node.type === schema.nodes.mediaSingle) {
                        var deco = prosemirror_view_1.Decoration.node(state.selection.from, state.selection.to, {
