...
var Resizer = /** @class */ (function (_super) {
    ...
    function Resizer() {
        ...
        _this.handleResizeStart = function () {
            _this.setState({ isResizing: true }, function () {
                _this.props.displayGrid(true, grid_1.gridTypeForLayout(_this.props.layout), _this.highlights(_this.props.width));
            });
        };
        _this.handleResize = function (event, direction, elementRef, delta) {
            ...
            _this.props.displayGrid(true, grid_1.gridTypeForLayout(newSize.layout), _this.highlights(newWidth));
        ...
        _this.highlights = function (newWidth) {
            ...
            var columns = editor_common_1.calcColumnsFromPx(snapWidth, _this.props.lineLength, _this.props.gridSize);
    ...
    Resizer.prototype.render = function () {
        ...
        var shouldHalfSize = exports.alignementLayouts.indexOf(this.props.layout) > -1 &&
            this.props.width > this.props.lineLength;
        var handleStyles = {};
        var handles = {};
        exports.handleSides.forEach(function (side) {
            var _a;
        ...
        return (React.createElement(re_resizable_1.default, { ref: this.setResizableRef, onResize: this.handleResize, size: {
