...
exports.fixCursorAlignment = function (view) {
    ...
    if (targetNode.type === schema.nodes.table) {
        var tableFullMarginTop = editor_common_1.tableMarginTop + styles_1.tableInsertColumnButtonSize / 2;
...
exports.isIgnoredClick = function (elem) {
    ...
    if (tableWrap) {
        ...
        var columnControls = tableWrap.querySelector("." + types_1.TableCssClassName.COLUMN_CONTROLS_WRAPPER);
