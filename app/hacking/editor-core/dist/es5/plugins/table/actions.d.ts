...
export declare const hoverColumns: (columns: number[], isInDanger?: boolean | undefined) => Command;
export declare const hoverRows: (rows: number[], isInDanger?: boolean | undefined) => Command;
...
export declare const deleteSelectedColumns: Command;
export declare const deleteSelectedRows: Command;
...
export declare const deleteColumns: (indexes: number[]) => Command;
export declare const deleteRows: (indexes: number[]) => Command;
...
export declare const setTableRef: (tableRef?: HTMLElement | undefined) => Command;
